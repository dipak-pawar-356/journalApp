...
public class JournalEntryController {
    ...
    public JournalEntryController(UserService userService) {
...
//    }
    ...
    public ResponseEntity<?> getJournalEntryById(@PathVariable ObjectId myId) {
        try {
            ...
            return null; // or throw a custom 400 Bad Request
        }
    ...
    public ResponseEntity<?> updateJournalById(
        ...
        if(!collect.isEmpty()){
            ...
            if(journalEntry.isPresent()) {
                ...
                journalEntryService.saveEntry(old); // Save updated old entry
