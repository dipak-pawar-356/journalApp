    ...
    public ResponseEntity<?> updateJournalById(
        ...
        if (owns) {
            ...
            if (journalEntry.isPresent()) {
                ...
                old.setTitle(Optional.ofNullable(newEntry.getTitle()).filter(t -> !t.isBlank()).orElse(old.getTitle()));
                old.setContent(Optional.ofNullable(newEntry.getContent()).filter(c -> !c.isBlank()).orElse(old.getContent()));
